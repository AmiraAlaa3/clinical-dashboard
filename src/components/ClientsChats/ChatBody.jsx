...
export default function ChatBody() {
  return (
    <div className='p-3'>
      <div className={`d-flex align-items-center mb-3 ${styles.chatHeader}`}>
        <div className='d-flex align-items-center w-100 justify-content-between'>
          ...
          <IconButton aria-label="morevert" sx={{
            bgcolor: '#FFF'
          }} >
            <MoreVert />
          </IconButton>
      ...
      <div className='p-4' style={{ height: "400px", overflowY: "auto" }}>
        <div className="d-flex flex-row justify-content-start">
          <div>
            ...
            <p className={`${styles.time} small ms-3 mb-3 rounded-3 text-muted float-end`}>
              12:00 PM | Aug 13
            </p>
          </div>
        </div>
        ...
        <div className="d-flex flex-row justify-content-end">
          <div>
            ...
            <p className={`${styles.time} small me-3 mb-3 rounded-3 text-muted`}>
              12:00 PM | Aug 13
            </p>
          </div>
        </div>
